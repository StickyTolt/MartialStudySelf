...
public class ParentOnePictureFragment extends Fragment implements LoadingIsShown {
    ...
    private void initView() {
        ...
        ParentJsonParse.ParentParse(adapter, MyUrl.PARENT_ONE_PIC_URL + page);
    }

    @Override
    public void isShownLoad() {
        page++;
        ParentJsonParse.ParentParseLoad(adapter,MyUrl.PARENT_ONE_PIC_URL + page);
    }
}

...
public class TalkMartialFragment extends Fragment implements ICommentItem, View.OnClickListener, INotifyAddRes {
    ...
    public void addResForI() {
        PAGE_NUM++ ;
        JsonParseAndUpdate.commentJPAA(adapter,HttpUrl.COMMENT_URL+PAGE_NUM);
    }
}

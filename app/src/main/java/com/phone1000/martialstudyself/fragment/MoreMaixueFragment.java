...
public class MoreMaixueFragment extends Fragment implements INotifyAddRes, IItemMoreItem {
    ...
    private void initView() {
        ...
        data = WushubaikeModel.getWushubaike().经络脉穴;
        ...
        JsonParseAndUpdate.moreItemJPAU(adapter, HttpUrl.MORE_MAIXUE+page,JsonParseAndUpdate.UPDATE);
    }

    @Override
    public void addResForI() {
        page++ ;
        JsonParseAndUpdate.moreItemJPAU(adapter,HttpUrl.MORE_MAIXUE+page,JsonParseAndUpdate.ADD);
    }

...
public class ParentTwoQiXieFragment extends Fragment implements LoadingIsShown {
    ...
    private void initView() {
        ...
        ParentJsonParse.ParentParse(adapter, MyUrl.PARENT_TWO_QIXIE_URL + page);
    }

    @Override
    public void isShownLoad() {
        page++;
        ParentJsonParse.ParentParseLoad(adapter,MyUrl.PARENT_TWO_QIXIE_URL + page);
    }
}

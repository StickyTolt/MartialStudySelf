 ...
 */
public class SearchGridViewAdapter extends BaseAdapter implements CompoundButton.OnCheckedChangeListener {

    private static final String TAG = SearchGridViewAdapter.class.getSimpleName();
    ...
    public SearchGridViewAdapter(Context context, List<String> data) {
